...
const InquiryPanel = () => {
  ...
  return (
    ...
    {
      problemSubmit?
      <CustomerProblemSubmit setProblemSubmit={setProblemSubmit}/>:
              ...
              <li key={item.id} className={styles.listItem}>
                ...
                {openInquiryId === item.id && (
                  <div className={styles.detailContentArea}>
                    {(!passwordValidatedInquiries[item.id] && item.postPassword !==null && user?.auth!=='ROLE_ADMIN')? (
