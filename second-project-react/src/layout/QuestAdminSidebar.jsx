...
const QuestAdminSidebar = ({setActiveQuestMenu}) => {
  ...
  return (
    <div>
      ...
      {isReportMenuOpen && (
        <ul className="submenu-list">
          <li><button className="questRegiCallManageBtn" onClick={()=> setActiveQuestMenu('regiCallManage')}>문제 등록 요청 관리</button></li>
          <li><button className="questErrRepoManageBtn" onClick={()=> setActiveQuestMenu('errReportManage')}>문제 오류 제보 관리</button></li>
        </ul>
      )}
    </div>
  );
...
export default QuestAdminSidebar;